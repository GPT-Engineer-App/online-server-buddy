...
**Project**: online-server-buddy 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Crie um servidor de um on-line completo, funcionando e hospede em algum servidor gratuito  
...
```sh
git clone https://github.com/GPT-Engineer-App/online-server-buddy.git
cd online-server-buddy
npm i
